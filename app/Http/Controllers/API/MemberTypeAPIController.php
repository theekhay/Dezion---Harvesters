...
use App\Http\Requests\API\CreateMemberTypeAPIRequest;
use App\Http\Requests\API\UpdateMemberTypeAPIRequest;
...
class MemberTypeAPIController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->sendResponse($memberTypes->toArray(), 'Member Types retrieved successfully');
    }
    ...
    public function store(CreateMemberTypeAPIRequest $request)
    {
        ...
        return $this->sendResponse($memberTypes->toArray(), 'Member Type saved successfully');
    }
    ...
    public function show($id)
    {
        ...
        return $this->sendResponse($memberType->toArray(), 'Member Type retrieved successfully');
    }
